...
class TestPhaseOne(unittest.TestCase):
    ...
    def test_script_byte_format(self):
        ...
        self.assertEqual(script_byte_format(script), b'\x63'+struct.pack('B', len(x_only_pubkey))+x_only_pubkey+b'\xac'+b'\x67'+b'\x4d'+struct.pack('>H', len(dilithium_pubkey))[::-1]+dilithium_pubkey+b'\xc0'+b'\x68')
